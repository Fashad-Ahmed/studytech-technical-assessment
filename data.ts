...
export const questions: Question[] = [
  {
    ...
    question:
      "Which AWS pricing model helps customers avoid large upfront infrastructure costs?",
    options: [
      "Pay-as-you-go",
      "Reserved billing only",
      "Fixed yearly contracts",
      "Manual invoicing",
    ],
  ...
  },
  {
    ...
    question:
      "Which cloud concept allows resources to scale up or down based on demand?",
    options: [
      "Elasticity",
      "Hard coding",
      "Manual procurement",
  ...
  },
  {
    ...
    question:
      "Moving from buying physical servers to paying for cloud usage is mainly a shift from what to what?",
    options: [
      "CapEx to OpEx",
      "OpEx to CapEx",
      "SaaS to hardware",
      "Regions to Availability Zones",
    ],
  ...
  },
  {
    ...
    question:
      "Under the AWS Shared Responsibility Model, who is responsible for managing customer data?",
    options: [
      "The customer",
      "AWS only",
      "AWS Support",
  ...
  },
  {
    ...
    skillId: "skill_mfa",
    question:
      "Which security feature adds an extra layer of protection during sign-in?",
  ...
  },
  {
    ...
    question:
      "Which S3 feature helps optimize storage costs based on access patterns?",
    options: [
      "S3 storage classes",
      "IAM users",
      "Security groups",
  ...
  },
  {
    ...
    question:
      "Which AWS service collects metrics and logs for monitoring resources?",
  ...
  },
  {
    ...
    question:
      "Which AWS service can alert you when your spending exceeds a defined threshold?",
  ...
  },
  {
    ...
    question:
      "Which AWS service helps visualize, understand, and manage AWS costs over time?",
    options: [
      "AWS Cost Explorer",
      "AWS Lambda",
  ...
  },
  {
    ...
    question:
      "Which AWS Support plan is most appropriate for business-critical workloads?",
    options: [
      "Business Support",
      "Basic Support",
      "Free Tier Support",
